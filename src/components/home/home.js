                ...
                <div className='webBodyWrapper'>
                    ...
                    <div className='webBodyRight'>
                        ...
                        <div className='wBR-container'>
                            ...
                            <p className='wBR-p1'>
                                <span className='wBR-green'>Projects:</span><br></br><br></br>
                                <span className='wBR-green'>Zode: </span>I handled the front-end part of Zode using React.js. Zode is a platform where all developers can interact and plan their 
                                ...
                                <span className='wBR-green'>CliqServe: </span>I developed the front-end part of CliqServe (Github Repository Name: codename-prox), using Vue.js. 
                            ...
                            <p className='wBR-p1'>
                                <span className='wBR-green'>Contact Details:</span><br></br><br></br>Email: <span className='wBR-green'>alanmatw@gmail.com</span><br></br>Phone: <span className='wBR-green'>+1 647-928-3049</span>
